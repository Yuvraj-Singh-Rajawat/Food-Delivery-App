  ...
  return (
    <div className="navbar py-5 flex justify-between items-center">
      ...
      <div className="navbar-right flex items-center gap-10 max-[750px]:gap-5">
        <a
          href="https://food-delivery-app-admin-5jy6.onrender.com"
          target="_blank"
          ...
          <div
            className={
              getTotalCartAmount() === 0
                ? ""
                : "dot absolute min-w-3 min-h-3 bg-red-400 rounded-md top-[-8px] right-[-8px]"
            }
          ></div>
        </div>
        {!token ? (
          <button
            ...
            className="bg-transparent text-[16px] text-[#49557e] border-[1px] border-solid border-red-400 px-7 py-2 rounded-[50px] cursor-pointer transition hover:bg-[#fff4f2] duration-300"
          >
            sign in
          </button>
        ) : (
          <div className="navbar-profile relative">
            ...
            <ul className="nav-profile-dropdown absolute hidden right-0 z-[1]">
              <li
                ...
                className="flex items-center gap-[10px] cursor-pointer pr-8 hover:text-[tomato]"
              >
